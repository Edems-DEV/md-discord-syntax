...
- Italic inside spoiler: ||This is _italic secret_ text||.
- Inline code inside spoiler: ||Code `const x = 42;` inside spoiler||.
- Complex mixed formatting: ||**Bold**, _Italics_, ~~Strikethrough~~, and `code` inside||.
...
-# Subtext containing **bold text**, _italic text_, and a ||spoiler inside subtext||.
